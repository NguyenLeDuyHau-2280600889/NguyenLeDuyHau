...
.delete-btn {
    ...
    background: linear-gradient(45deg, #e74c3c, #c0392b); /* đỏ tươi, đậm hơn */
    border: none;
...
.quantity-input {
    ...
    padding: 5px;
    border-radius: 4px;
    border: 1px solid #ccc; /* đổi sang xám nhẹ */
    transition: all 0.3s ease;
}

.quantity-input:focus {
    border-color: #4e54c8; /* tím xanh tươi */
